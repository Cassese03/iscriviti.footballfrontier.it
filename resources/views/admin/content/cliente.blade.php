<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0"><?php echo $cliente->codice.' - '.$cliente->nome ?></h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="d-flex flex-row justify-content-end">
              ...
              <span>
                    <i class="fas fa-square text-gray"></i> Anno 2020
                  </span>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <h2 style="padding:20px">Storico</h2>
          <div class="card-body table-responsive">
            <table class="table table-striped table-valign-middle datatable" style="width:100%">
              ...
              <tr>
                <td><?php echo $s->nome_articolo ?></td>
                <td><?php echo $s->data_documento ?></td>
                <td><?php echo $s->quantita.' x '.$s->um ?></td>
                <td>&euro;<?php echo $s->prezzo_in_euro ?></td>
                <td><a class="btn btn-success" target="_blank" href="<?php echo URL::asset('/admin/articolo/'.$s->id_articolo ) ?>">Dettagli</a></td>
              </tr>
              <?php } ?>
        ...
        <div class="card">
          <h2 style="padding:20px">Vendite</h2>
          <div class="card-body table-responsive">
            <table class="table table-striped table-valign-middle datatable" style="width:100%">
              <thead>
              <tr>
              ...
              <?php foreach($vendite as $v){ ?>
                <tr>
                  <td><?php echo $v->nome_articolo ?></td>
                  <td><?php echo $v->data_documento ?></td>
                  <td><?php echo $v->quantita.' x '.$v->um ?></td>
                  <td>&euro;<?php echo $v->prezzo_in_euro ?></td>
                  <td><a class="btn btn-success" target="_blank" href="<?php echo URL::asset('/admin/articolo/'.$v->id_articolo ) ?>">Dettagli</a></td>
                </tr>
              <?php } ?>
...
<script type="text/javascript">
  ...
  document.title="<?php echo $cliente->nome  ?>"
</script>