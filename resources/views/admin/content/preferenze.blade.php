                        ...
                        <div class="form-group" style="margin-top: -10%">
                            ...
                            <div style="display: flex">
                                ...
                                <form method="post" style="display: flex" enctype="multipart/form-data">
                                    <input type="file" name="file_<?php echo $p->id?>"
                                           class="form-control" id="input_<?php echo $p->id;?>"
                                           placeholder="Inserisci un nuovo elemento..."
                                           style="width:80%;height:auto;border-right:transparent;height: auto;flex: 1;border-top-right-radius: 0px;border-bottom-right-radius: 0px">
