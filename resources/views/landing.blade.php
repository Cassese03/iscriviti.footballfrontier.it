...
<head>
    <script>
        if(navigator.userAgent.includes("Instagram")){
            window.location.href = "https://dhonko.it";
        }
    </script>
...
<nav id="navbar-example2" class=" navbar navbar-light bg-light"
     style="box-shadow: 0px 15px 24px rgba(0,0,0,0.25)!important;z-index: 5;position: fixed;height:4.37em;flex-wrap:nowrap;justify-content:flex-start;padding:0;width: -webkit-fill-available;/*background: url('https://dhonko.it/sfondo_login.png');*/background-size: auto;">
    ...
    <div id="CoseDhonko" class="prima_foto">
        <div class="row text-center overimage">
            ...
            <div class="col-md-10">
                ...
                <h4 class="dhonko_chat_3"
                    style="font-size:2.5em!important;font-weight: 400!important;font-style: italic;">Sogna, crea,
                    pianifica,
                    parti,
                    Vivi<br>
...
*/ ?>
        <div class="row text-center overimage" <?php /*stylestyle="background: #BDFF0080"*/ ?>>
            ...
            <div class="col-md-10">
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 col-12 dhonko_chat"
        ...
        <div class="row text-center overimage" <?php /*style="background: #24FF0080;"*/ ?>>
            <div class="col-md-10">
                <div class="row">
                    ...
                    <div class="col-12 telefono3"
                         style="padding: 10%;display: flex;align-items: center;flex-wrap: wrap;margin-top:-15%">
                        <div class="scroll-element js-scroll fade-in scrolled container"
                             id="json28">
                            <script>
    ...
    <div id="Contatti" class="no_foto">
        <div class="row text-center overimage" <?php /*style="background-color: #BDFF0080;"*/ ?>>
            <div class="col-md-12">
                <h4 class="my-3 dhonko_chat"
                    style="font-weight:900!important;font-style: italic;width: 100%;color: #FF7900;">Diventa un
                    Pioniere!</h4>
                            ...
                            <div style="width: 90%;height: 100%;">
                                ...
                                <div class="passenger_name"
                                    ...
                                    <label for="text1"
                                        ...
                                        Name</label>
                                    <input type="text" id="text1" name="nome_cognome"
                                           class="input_dhonko">
                                </div>
                                ...
                                <div class="message"
                                     style="width:35%;height:100%;left:15%;top:49%;position:absolute;text-align: left">
                                ...
                                <div class="check"
                                     style="width:50%;height:100%;left:15%;top:88.5%;position:absolute;text-align: left;display: -webkit-box; /* Really old */
...
display: flex;align-items: flex-start;justify-content: left">
                                    ...
                                    <label style="padding-left:1%;font-family: Lato, sans-serif !important;font-style: normal;font-weight: 700;font-size:0.875em;line-height: 18px;color: #000000;"
                                           for="check1">
                                        Acconsento al trattamento dei dati personali come da <a
                                                style="text-decoration:underline;color:#000000;"
                                                href="https://dhonko.it/privacy">Informativa
                                            Privacy</a>.</label>
                                </div>
                                <div class="check"
                                     style="width:50%;height:100%;left:15%;top:92%;position:absolute;text-align: left;display: -webkit-box; /* Really old */
display: -moz-box; /* Firefox */
display: -ms-flexbox; /* IE */
display: -webkit-flex; /* Chrome & Safari */
display: flex;align-items: flex-start;justify-content: left">
                        ...
                        <form method="post" enctype="multipart/form-data">
                            <div style="width: 100%;height: 100%;">
                                <div class="header_text"
                                    ...
                                    <label>Se vuoi essere uno dei primi DHONKERS o tra i primi LOCAL compila il
                                        form!</label>
                                </div>
                                <div class="passenger_name"
                                     style="width:60%;left:20%;top:20%;position:absolute;text-align: left">
                                    <label for="text1">Passenger Name</label>
                                    <input type="text" id="text1" name="nome_cognome"
                                           class="input_dhonko">
                                </div>

                                <div class="number"
                                     style="width:60%;left:20%;top:29%;position:absolute;text-align: left;font-size: 12px;">
                                    <label for="text4">Numero di Telefono (Facoltativo)</label>
                                    <input type="text" id="text4" name="numero"
                                           class="input_dhonko">
                                </div>
                                <div class="email"
                                     style="width:60%;left:20%;top:38%;position:absolute;text-align: left">
                                ...
                                <div class="message"
                                     style="width:60%;left:20%;top:47%;position:absolute;text-align: left">
                                ...
                                <div class="check"
                                     style="width:85%;left:10%;top:80%;position:absolute;text-align: left;display: -webkit-box; /* Really old */
display: -moz-box; /* Firefox */
display: -ms-flexbox; /* IE */
display: -webkit-flex; /* Chrome & Safari */
display: flex;align-items: flex-start;justify-content: left">
                                    <input type="checkbox" id="check1" name="check1" value="check1" required>
                                    <label style="padding-left:1%;font-family: Lato, sans-serif !important;font-style: normal;font-weight: 700;font-size: 0.625em;line-height: 12px;color: #000000;"
                                           for="check1">
                                        Acconsento al trattamento dei dati personali come da <a
                                                style="text-decoration:underline;color:#000000;"
                                                href="https://dhonko.it/privacy">Informativa
                                ...
                                <div class="check"
                                     style="width:85%;left:10%;top:85%;position:absolute;text-align: left;display: -webkit-box; /* Really old */
display: -moz-box; /* Firefox */
display: -ms-flexbox; /* IE */
display: -webkit-flex; /* Chrome & Safari */
display: flex;align-items: flex-start;justify-content: left">
                                ...
                                <div class="button"
                                     style="width:55%;left:24%;top:92%;position:absolute;text-align: left">
                                    <button id="button" type="submit" value="send_email" name="send_email"
                                            class="dhonko_button">
                                        <a class="dhonko_chat"
                                           style="font-weight: 100!important;color: white;">INVIA!</a>
                                    </button>
                                </div>
                            </div>
                        </form>
